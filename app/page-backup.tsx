...
>
      <div className="max-w-7xl w-full px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 md:mb-14">
          ...
          <span className="inline-block bg-white/60 text-red-600 px-3 py-2 md:px-5 rounded-full text-[10px] sm:text-xs md:text-sm font-semibold">
            100% GRATIS · SIN COMPROMISO · RESPUESTA EN MENOS DE 24H
          </span>

          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 mt-6 mb-6 leading-tight">
            ELIGE CÓMO QUIERES
            <br />
            COMPARAR TU FACTURA
          </h1>

          <p className="text-black text-base sm:text-lg md:text-xl max-w-3xl mx-auto px-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="relative bg-white rounded-3xl shadow-xl p-6 md:p-10 border hover:shadow-2xl hover:-translate-y-2 transition duration-300">
  ...
  >
    Subir mi factura →
          ...
          <div className="bg-white rounded-3xl shadow-xl p-10 border hover:shadow-2xl hover:-translate-y-2 transition duration-300">
            ...
            <div className="w-20 h-20 md:w-24 md:h-24 rounded-3xl bg-red-50 flex items-center justify-center mx-auto text-5xl">
                📊
            </div>
